...
// Reconocimiento de voz, reactivo al idioma fuente
...
watch(translatedText1, (newValue) => { trans1.value = newValue })
watch(translatedText2, (newValue) => { trans2.value = newValue })
    ...
    <aside class="w-full h-full overflow-y-auto bg-background text-foreground">
      <div class="p-4">
        <div class="max-w-7xl mx-auto">
          <SettingsPanel />
          <div class="mt-4 p-3 rounded-[var(--radius)] shadow-sm"
               :class="[
                  isListening
